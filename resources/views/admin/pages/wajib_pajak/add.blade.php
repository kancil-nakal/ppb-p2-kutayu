    ...
    <div class="row">
        <div class="col-12">
            ...
            <div class="card-body ">
                ...
                <h5 class="card-title"><i class="bi bi-person-plus me-1"></i>Tambah Wajib Pajak</h5>
                ...
                <form class="row g-3" action="{{ route('wajibpajak.store') }}" method="POST">
                    @csrf
                    <div class="row">
                        <div class="col-lg-6">
                            <div class="col-12 mt-3">
                                ...
                                <input type="text" class="form-control @error('no_sppt')
                                    border-danger
                                @enderror" name="no_sppt" id="no_sppt" value="{{ old('no_sppt') }}" class="form-control" autocomplete="off">
                                @error('no_sppt')
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="text" class="form-control @error('nama')
                                    border-danger
                                @enderror" name="nama" id="nama" value="{{ old('nama') }}" class="form-control" autocomplete="off">
                                @error('nama')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <input type="number" class="form-control @error('tahun')
                                    border-danger
                                @enderror" min="1900" max="2999" step="1" name="tahun" id="tahun" value="{{ old('tahun', date('Y')) }}" class="form-control" autocomplete="off">
                                @error('tahun')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <input type="number" class="form-control @error('rt')
                                        border-danger
                                    @enderror" min="001" max="999" step="1" name="rt" id="rt" value="{{ old('rt') }}" class="form-control" autocomplete="off">
                                    @error('rt')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                    <input type="number" class="form-control @error('rw')
                                        border-danger
                                    @enderror" min="001" max="999" step="1" name="rw" id="rw" value="{{ old('rw') }}" class="form-control" autocomplete="off">
                                    @error('rw')
                                        <small class="text-danger">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea  class="form-control @error('alamat_pemilik')
                                    border-danger
                                @enderror" name="alamat_pemilik" id="alamat_pemilik"  class="form-control" >{{ old('alamat_pemilik') }}</textarea>
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <textarea  class="form-control @error('objek_pajak')
                                    border-danger
                                @enderror" name="objek_pajak" id="objek_pajak"  class="form-control" >{{ old('objek_pajak') }}</textarea>
                                @error('objek_pajak')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="col-12 mt-3">
                                ...
                                <input type="number" class="form-control @error('luas_bumi')
                                    border-danger
                                @enderror" name="luas_bumi" id="luas_bumi"   class="form-control" value="{{ old('luas_bumi')}}">
                                @error('luas_bumi')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <input type="number" class="form-control @error('luas_bangunan')
                                    border-danger
                                @enderror" name="luas_bangunan" id="luas_bangunan"  class="form-control" value="{{ old('luas_bangunan')}}">
                                @error('luas_bangunan')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <input type="number" class="form-control @error('pagu_pajak')
                                    border-danger
                                @enderror" name="pagu_pajak" id="pagu_pajak"  class="form-control" value="{{ old('pagu_pajak')}}">
                                @error('pagu_pajak')
                                    <small class="text-danger">{{ $message }}</small>
                                @enderror
                            </div>
                            <div class="col-12 mt-3">
                                ...
                                <select class="form-select @error('id_user')
                                    ...
                                    @foreach ($data['users'] as $key => $value )
                                        <option value="{{ $value->id }}" {{ old('id_user') == $value->id ? 'selected' : '' }}>{{ $value->name }}</option>
                                    @endforeach
                                </select>
                                @error('id_user')
                                    <small class="text-danger">{{ $message }}</small>
